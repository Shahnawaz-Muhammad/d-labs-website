      ...
      <div className="max-w-screen-xl w-full pt-10 px-8 xl:px-0 ">
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-20  pt-10 lg:pt-28  pb-4">
          ...
          <div className="w-full md:w-1/2 ">
            ...
            <p className="text-justify pt-6 lg:pt-10 px-2 text-[#cdcdcd]">
            ...
            <div className=" h-[2px] bg-black mt-8 mx-2"></div>
            <h1 className="pt-8 text-[#cdcdcd]">
              <span className="font-bold mr-2 text-black text-2xl">1</span>{" "}
              Actual office space that promotes productivity
            </h1>
            <div className=" h-[2px] bg-black mt-6 mx-2 lg:mt-10"></div>
            <h1 className="pt-10 text-[#cdcdcd]">
