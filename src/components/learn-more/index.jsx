  ...
  return (
    ...
    <div className="max-w-screen-xl w-full py-20 px-8 xl:px-0">
      ...
      <div className="flex flex-col items-center text-center pt-10 lg:pt-28 ">
        ...
        <p className="pt-10  max-w-lg">By saying that our coworking space is sustainable and comfy we confirm that you will get 100% satisfaction from working here and making the best out of this experience.</p>
